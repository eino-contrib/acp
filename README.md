...
| `server.WithPendingQueueSize(n)` | `1024` | Messages buffered between session creation and the first GET SSE listener |
...
| Inbox / Outbox buffers | `1024` / `1024` | `1024` + `1024` pending | `1024` / `1024` |
